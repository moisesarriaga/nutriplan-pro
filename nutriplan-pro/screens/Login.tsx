      ...
      <div className="flex-1 flex flex-col px-6 pt-4 pb-12 w-full max-w-md mx-auto">
        ...
        <div className="flex justify-center gap-4 mt-2">
          ...
          <button
            ...
            className="flex items-center justify-center h-12 w-12 bg-white dark:bg-[#131314] border border-[#747775] dark:border-[#8e918f] rounded-full hover:shadow-md transition-all"
          >
